											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
                                                  ...
                                                  <div class="tab-pane fade" id="all_ssr_linux">
													...
													{if $display_ios_class>=0}
														...
														{/if}
													{/if}
													<p><span class="icon icon-lg text-white">filter_1</span> 在 Safari 中<a class="btn-dl" href="itms-services://?action=download-manifest&url=https://www.ghbcq.ml/ssr-download/Shadowrocket.plist"><i class="material-icons">save_alt</i> 点击安装 Shadowrocket</a>安装后，点击打开Shadowrocket输入上方账号密码即可 </p>
														<p><span class="icon icon-lg text-white">filter_2</span> 打开 Shadowrocket，点击添加代理，点击右上角的 + 号，选择“订阅”，名字任意填写，开启自动更新，URL填写以下地址并保存即可</p>
														...
														{/if}
                                                      <p><a href="/user/announcement#all_ssr_ios">点击这里查看iOS傻瓜式教程</a></p>
													</div>
													<div class="tab-pane fade" id="all_ssr_android">
                                                      ...
                                                      <p><a href="/user/announcement#all_ssr_android">点击这里查看Android傻瓜式教程</a></p>
													</div>
												...
												<div class="tab-pane fade {if !$ssr_prefer}active in{/if}" id="all_ss">
													...
													{if $display_ios_class>=0}
														...
														{/if}
													{/if}
                                                        <p><span class="icon icon-lg text-white">filter_1</span> 在 Safari 中点击<a href="itms-services://?action=download-manifest&url=https://www.ghbcq.ml/xhj/ipa.plist">这里</a>安装 Shadowrocket</p>
